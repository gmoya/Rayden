...
class ProvinciaTableMap extends TableMap {
	...
	{
    $this->addRelation('Domicilio', 'Domicilio', RelationMap::ONE_TO_MANY, array('id' => 'provincia_id', ), null, null);
    $this->addRelation('Localidad', 'Localidad', RelationMap::ONE_TO_MANY, array('id' => 'provincia_id', ), null, null);
	} // buildRelations()
