...
abstract class BaseDocente extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseDocente object.
	 * @see        applyDefaults()
	 */
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = DocentePeer::ESTADO;
		}
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = DocentePeer::CREATED_BY_ID;
		}
	...
	public function setUpdatedById($v)
	{
		...
		if ($this->updated_by_id !== $v) {
			...
			$this->modifiedColumns[] = DocentePeer::UPDATED_BY_ID;
		}
	...
	public function setDeletedById($v)
	{
		...
		if ($this->deleted_by_id !== $v) {
			...
			$this->modifiedColumns[] = DocentePeer::DELETED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->estado = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->persona_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->created_at = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->created_by_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->updated_at = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->updated_by_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->deleted_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->deleted_by_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = DocentePeer::NUM_COLUMNS - DocentePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getCreatedById(),
			$keys[5] => $this->getUpdatedAt(),
			$keys[6] => $this->getUpdatedById(),
			$keys[7] => $this->getDeletedAt(),
			$keys[8] => $this->getDeletedById(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCreatedById($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setUpdatedAt($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setUpdatedById($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setDeletedAt($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setDeletedById($arr[$keys[8]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocentePeer::ESTADO)) $criteria->add(DocentePeer::ESTADO, $this->estado);
		...
		if ($this->isColumnModified(DocentePeer::CREATED_BY_ID)) $criteria->add(DocentePeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(DocentePeer::UPDATED_AT)) $criteria->add(DocentePeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(DocentePeer::UPDATED_BY_ID)) $criteria->add(DocentePeer::UPDATED_BY_ID, $this->updated_by_id);
		if ($this->isColumnModified(DocentePeer::DELETED_AT)) $criteria->add(DocentePeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(DocentePeer::DELETED_BY_ID)) $criteria->add(DocentePeer::DELETED_BY_ID, $this->deleted_by_id);
	...
	public function setsfGuardUserRelatedByCreatedById(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addDocenteRelatedByCreatedById($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedById === null && ($this->created_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByCreatedById->addDocentesRelatedByCreatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addDocenteRelatedByUpdatedById($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedById === null && ($this->updated_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUpdatedById->addDocentesRelatedByUpdatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDeletedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addDocenteRelatedByDeletedById($this);
		}
	...
	public function getsfGuardUserRelatedByDeletedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDeletedById === null && ($this->deleted_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDeletedById->addDocentesRelatedByDeletedById($this);
			 */
		}
