...
abstract class BaseAlumno extends BaseObject  implements Persistent {
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = AlumnoPeer::ESTADO;
		}
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = AlumnoPeer::CREATED_BY_ID;
		}
	...
	public function setUpdatedById($v)
	{
		...
		if ($this->updated_by_id !== $v) {
			...
			$this->modifiedColumns[] = AlumnoPeer::UPDATED_BY_ID;
		}
	...
	public function setDeletedById($v)
	{
		...
		if ($this->deleted_by_id !== $v) {
			...
			$this->modifiedColumns[] = AlumnoPeer::DELETED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->legajo = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->persona_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->beca = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			$this->regular = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->regular_at = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->estado = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->created_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->created_by_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->updated_at = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->updated_by_id = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->deleted_at = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->deleted_by_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
			$this->resetModified();
			...
			return $startcol + 13; // 13 = AlumnoPeer::NUM_COLUMNS - AlumnoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getLegajo(),
			$keys[2] => $this->getPersonaId(),
			$keys[3] => $this->getBeca(),
			$keys[4] => $this->getRegular(),
			$keys[5] => $this->getRegularAt(),
			$keys[6] => $this->getEstado(),
			$keys[7] => $this->getCreatedAt(),
			$keys[8] => $this->getCreatedById(),
			$keys[9] => $this->getUpdatedAt(),
			$keys[10] => $this->getUpdatedById(),
			$keys[11] => $this->getDeletedAt(),
			$keys[12] => $this->getDeletedById(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setLegajo($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setPersonaId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setBeca($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setRegular($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setRegularAt($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setEstado($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setCreatedAt($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setCreatedById($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setUpdatedAt($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setUpdatedById($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setDeletedAt($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setDeletedById($arr[$keys[12]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AlumnoPeer::ESTADO)) $criteria->add(AlumnoPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(AlumnoPeer::CREATED_AT)) $criteria->add(AlumnoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(AlumnoPeer::CREATED_BY_ID)) $criteria->add(AlumnoPeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(AlumnoPeer::UPDATED_AT)) $criteria->add(AlumnoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(AlumnoPeer::UPDATED_BY_ID)) $criteria->add(AlumnoPeer::UPDATED_BY_ID, $this->updated_by_id);
		if ($this->isColumnModified(AlumnoPeer::DELETED_AT)) $criteria->add(AlumnoPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(AlumnoPeer::DELETED_BY_ID)) $criteria->add(AlumnoPeer::DELETED_BY_ID, $this->deleted_by_id);
	...
	public function setsfGuardUserRelatedByCreatedById(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addAlumnoRelatedByCreatedById($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedById === null && ($this->created_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByCreatedById->addAlumnosRelatedByCreatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addAlumnoRelatedByUpdatedById($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedById === null && ($this->updated_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUpdatedById->addAlumnosRelatedByUpdatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDeletedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addAlumnoRelatedByDeletedById($this);
		}
	...
	public function getsfGuardUserRelatedByDeletedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDeletedById === null && ($this->deleted_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDeletedById->addAlumnosRelatedByDeletedById($this);
			 */
		}
