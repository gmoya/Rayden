...
abstract class BaseLocalidad extends BaseObject  implements Persistent {
	...
	public function setCp($v)
	{
		...
		if ($this->cp !== $v) {
			$this->cp = $v;
			$this->modifiedColumns[] = LocalidadPeer::CP;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cp = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = LocalidadPeer::NUM_COLUMNS - LocalidadPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setCp($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LocalidadPeer::CP)) $criteria->add(LocalidadPeer::CP, $this->cp);
	 ...
	 * related Domicilios from storage. If this Localidad is new, it will return
		...
		if ($this->collDomicilios === null) {
			if ($this->isNew()) {
			   $this->collDomicilios = array();
				...
				$criteria->add(DomicilioPeer::LOCALIDAD_ID, $this->id);
