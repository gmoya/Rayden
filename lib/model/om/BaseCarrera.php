...
abstract class BaseCarrera extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseCarrera object.
	 * @see        applyDefaults()
	 */
	...
	public function setEstado($v)
	{
		...
		if ($this->estado !== $v || $this->isNew()) {
			$this->estado = $v;
			$this->modifiedColumns[] = CarreraPeer::ESTADO;
		}
	...
	public function setObservaciones($v)
	{
		...
		if ($this->observaciones !== $v) {
			...
			$this->modifiedColumns[] = CarreraPeer::OBSERVACIONES;
		}
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = CarreraPeer::CREATED_BY_ID;
		}
	...
	public function setUpdatedById($v)
	{
		...
		if ($this->updated_by_id !== $v) {
			...
			$this->modifiedColumns[] = CarreraPeer::UPDATED_BY_ID;
		}
	...
	public function setDeletedById($v)
	{
		...
		if ($this->deleted_by_id !== $v) {
			...
			$this->modifiedColumns[] = CarreraPeer::DELETED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->created_by_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->updated_at = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->updated_by_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->deleted_at = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->deleted_by_id = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->resetModified();
			...
			return $startcol + 11; // 11 = CarreraPeer::NUM_COLUMNS - CarreraPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getCreatedById(),
			$keys[7] => $this->getUpdatedAt(),
			$keys[8] => $this->getUpdatedById(),
			$keys[9] => $this->getDeletedAt(),
			$keys[10] => $this->getDeletedById(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setCreatedById($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setUpdatedAt($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setUpdatedById($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setDeletedAt($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setDeletedById($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CarreraPeer::ESTADO)) $criteria->add(CarreraPeer::ESTADO, $this->estado);
		if ($this->isColumnModified(CarreraPeer::OBSERVACIONES)) $criteria->add(CarreraPeer::OBSERVACIONES, $this->observaciones);
		if ($this->isColumnModified(CarreraPeer::CREATED_AT)) $criteria->add(CarreraPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(CarreraPeer::CREATED_BY_ID)) $criteria->add(CarreraPeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(CarreraPeer::UPDATED_AT)) $criteria->add(CarreraPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(CarreraPeer::UPDATED_BY_ID)) $criteria->add(CarreraPeer::UPDATED_BY_ID, $this->updated_by_id);
		if ($this->isColumnModified(CarreraPeer::DELETED_AT)) $criteria->add(CarreraPeer::DELETED_AT, $this->deleted_at);
		if ($this->isColumnModified(CarreraPeer::DELETED_BY_ID)) $criteria->add(CarreraPeer::DELETED_BY_ID, $this->deleted_by_id);
	...
	public function setsfGuardUserRelatedByCreatedById(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addCarreraRelatedByCreatedById($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedById === null && ($this->created_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUserRelatedByCreatedById->addCarrerasRelatedByCreatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addCarreraRelatedByUpdatedById($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedById === null && ($this->updated_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUpdatedById->addCarrerasRelatedByUpdatedById($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByDeletedById(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addCarreraRelatedByDeletedById($this);
		}
	...
	public function getsfGuardUserRelatedByDeletedById(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByDeletedById === null && ($this->deleted_by_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByDeletedById->addCarrerasRelatedByDeletedById($this);
			 */
		}
