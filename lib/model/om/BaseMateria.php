...
abstract class BaseMateria extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->carrera_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			return $startcol + 4; // 4 = MateriaPeer::NUM_COLUMNS - MateriaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCarreraId($arr[$keys[1]]);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCarreraId($this->carrera_id);
	...
	{
		if ($this->aCarrera === null && ($this->carrera_id !== null)) {
			$this->aCarrera = CarreraPeer::retrieveByPk($this->carrera_id);
