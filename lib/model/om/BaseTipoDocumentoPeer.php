...
/**
 * Base static class for performing query and update operations on the 'tipo_documento' table.
 *
 * 
 *
 * This class was autogenerated by Propel 1.4.2 on:
 *
 * Sat Oct 20 15:57:48 2012
 *
...
abstract class BaseTipoDocumentoPeer {
	...
	const TABLE_NAME = 'tipo_documento';

	/** the related Propel class for this table */
	const OM_CLASS = 'TipoDocumento';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.TipoDocumento';

	/** the related TableMap class for this table */
	const TM_CLASS = 'TipoDocumentoTableMap';
	...
	const ID = 'tipo_documento.ID';

	/** the column name for the NOMBRE field */
	const NOMBRE = 'tipo_documento.NOMBRE';

	/** the column name for the DESCRIPCION field */
	const DESCRIPCION = 'tipo_documento.DESCRIPCION';

	/**
	 * An identiy map to hold any loaded instances of TipoDocumento objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array TipoDocumento[]
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseTipoDocumentoPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      TipoDocumento $value A TipoDocumento object.
	 ...
	 *
	 * @param      mixed $value A TipoDocumento object or a primary key value.
	 */
	 ...
	 * @return     TipoDocumento Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tipo_documento
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseTipoDocumentoPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseTipoDocumentoPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new TipoDocumentoTableMap());
	  }
	}
	...
	{
		return $withPrefix ? TipoDocumentoPeer::CLASS_DEFAULT : TipoDocumentoPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseTipoDocumentoPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseTipoDocumentoPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseTipoDocumentoPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseTipoDocumentoPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseTipoDocumentoPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the tipo_documento table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			TipoDocumentoPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof TipoDocumento) { // it's a model object
	...
	public static function doValidate(TipoDocumento $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(TipoDocumentoPeer::DATABASE_NAME, TipoDocumentoPeer::TABLE_NAME, $columns);
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseTipoDocumentoPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseTipoDocumentoPeer::buildTableMap();
